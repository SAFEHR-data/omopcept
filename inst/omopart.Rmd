...
caption <- "SNOMED sharp accidents from OMOP. Plot made by Andy South using R, ggplot2 & omopcept. 2024-09-26."

#GOOD for A4 (not sure about plot & text sizing)
omop_graph( sharpr3,
            graphtitle="accidents with omopcept", titletxtsize = 20,
           canvas="A1",
           palettebrewer = "YlOrRd",
           palettedirection = -1,
           legendshow = FALSE,
