...
neor2 <- omop_relations("Malignant neoplasms",nsteps = 2,r="Subsumes")
...
neor1 <- omop_relations("Malignant neoplasms",nsteps = 1) #,r="Subsumes")
#they are only is a or subsumes
neor2all <- omop_relations("Malignant neoplasms",nsteps = 2)
...
neop_snomed_r1  <- omop_relations(neop_snomed$concept_id, nsteps = 1)
...
neop_snomed_r1s  <- omop_relations(neop_snomed$concept_id, nsteps = 1,
                                             r_ids="Subsumes")
...
neop_snomed_r2  <- omop_relations(neop_snomed$concept_id, nsteps = 2)
...
omop_graph(music_rel, plot=FALSE, filenameroot = "music-titled",width=36, height=48, units="in", node_txtsize = 14, graphtitle = "If music be the food of ... OMOP ...",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )
...
omop_graph(bloodgrouprels, plot=FALSE, filenameroot = "bloodgroup",width=36, height=48, units="in", node_txtsize = 14, graphtitle = "There will be blood ... in OMOP ...",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )
...
# this takes ages
#omop_graph(rrel_is_sub, plot=FALSE, filenameroot = "rrelations",width=36, height=48, units="in", node_txtsize = 14, graphtitle = "OMOP ART #1 : R relations",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )
...
omop_graph(rrel_is_sub3, plot=FALSE, filenameroot = "rrelations",width=36, height=48, units="in", node_txtsize = 14, graphtitle = "OMOP ART #1 : R relations",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )
...
omop_graph(cancer_rel_hemonc, plot=FALSE, filenameroot = "cancer_hemonc",width=36, height=48, units="in", node_txtsize = 14, graphtitle = "Cancer relations from HemOnc",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )
...
omop_graph(hemonc_rel_chemo, plot=FALSE, filenameroot = "chemo_hemonc",width=36, height=48, units="in", node_txtsize = 14, graphtitle = "Cytotoxic chemo relations from HemOnc",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )
...
omop_graph(hemonc_rel_has_chemo, plot=FALSE, filenameroot = "chemo_has_hemonc",width=36, height=48, units="in", node_txtsize = 14, graphtitle = "Cytotoxic chemo relations from HemOnc",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )


hemonc_rel_accepted_chemo <- hemonc_rel |> filter(relationship_id=="Accepted use of")
#3.8k rows

omop_graph(hemonc_rel_accepted_chemo, plot=FALSE, filenameroot = "chemo_hemonc_accepted",width=36, height=48, units="in", node_txtsize = 14, graphtitle = "Cytotoxic chemo relations from HemOnc",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )
...
omop_graph(hemonc_rel_lung, plot=FALSE, filenameroot = "chemo_hemonc_lung",width=36, height=48, units="in", node_txtsize = 14, graphtitle = "Lung chemo relations from HemOnc",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )
...
omop_graph(cancer_lung_rel, plot=FALSE, filenameroot = "cancer_lung",width=36, height=48, units="in", node_txtsize = 14, graphtitle = "Lung cancer relations",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )
...
omop_graph(preg_rel_isa, plot=FALSE, filenameroot = "preg_isa",width=100, height=60, units="in", node_txtsize = 14, graphtitle = "Pregnancy 'Is a' relations",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )
...
cert_live_birth_rel <- omop_relations(1012231, nsteps = 1)

omop_graph(cert_live_birth_rel, plot=FALSE, filenameroot = "cert_live_birth",width=30, height=20, units="in", node_txtsize = 18, graphtitle = "Certificate of live birth",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept  Commisions welcome! southandy@gmail.com" )
...
omop_graph(chr_rel, filenameroot = "omopmas", graphtitle = "Happy OMOPmas !",graphsubtitle = "made by @southmapr using OMOP, R & https://github.com/SAFEHR-data/omopcept",width=210, height=297, units="mm", node_txtsize = 24)
#A3
omop_graph(chr_rel, filenameroot = "omopmas", graphtitle = "Happy OMOPmas !",graphsubtitle = "made by @southmapr 2023 using OMOP, R & https://github.com/SAFEHR-data/omopcept",width=297, height=420, units="mm", node_txtsize = 24)
...
ajcc_rel1 <- omop_relations(734320, nsteps=1)
ajcc_rel2 <- omop_relations(734320, nsteps=2)
#does it make it quicker if I filter by vocab ? not hugely it seems
ajcc_rel2quick <- omop_relations(734320, nsteps=2, v_ids = "Cancer Modifier")
...
figo_rel1 <- omop_relations(734316, nsteps=1)
figo_rel2 <- omop_relations(734316, nsteps=2)
...
labcr1 <- omop_relations(labc$concept_id[1],nsteps = 1)
...
mmsr2 <- omop_relations(mms$concept_id, nsteps=2)
...
ra_rel1 <- omop_relations(ra$concept_id, nsteps=1)
ra_rel2 <- omop_relations(ra$concept_id, nsteps=2)
...
m06_rel <- omop_relations(m06$concept_id)
omop_graph(m06_rel)
m06_rel2 <- omop_relations(m06$concept_id, nsteps = 2)
...
sharpr2 <- omop_relations(sharp$concept_id, 
                                      r_ids=c('Is a','Subsumes'), 
                                      nsteps=2) 
sharpr_upr5 <- omop_relations(sharp$concept_id, 
                                      r_ids=c('Is a'), 
                                      nsteps=5) 
...
#4059 rows
# acc_downr7r <- omop_relations(acc$concept_id, 
#                                       r_ids=c('Subsumes'), 
#                                       nsteps=7) 
#write_csv(acc_downr7r,file=here("..","omopcept-plots","data","acc_downr7r.csv"))
acc_downr7r <- read_csv(here("..","omopcept-plots","data","acc_downr7r.csv"))
...
#MAKE AN A4 version with fewer concepts
#may have to rerun relations query

sharp <- omop_names("Accident caused by sharp-edged object", standard="S")

sharpr3 <- omop_relations(sharp$concept_id, 
                                      r_ids=c('Is a','Subsumes'), 
                                      nsteps=3) 
sharpr4 <- omop_relations(sharp$concept_id, 
                                      r_ids=c('Is a','Subsumes'), 
                                      nsteps=4) 

caption <- 'OMOP visualisation with omopcept github.com/SAFEHR-data/omopcept\n
            sharp <- omop_names("Accident caused by sharp-edged object", standard="S")\n
            sharpr3 <- omop_relations(sharp$concept_id, r_ids=c("Is a","Subsumes"), nsteps=3)\n
            omop_graph( sharpr3 )'

#4POSTER GOOD for A4 (not sure about plot & text sizing)
omop_graph( sharpr3,
            graphtitle="Accident caused by sardine tin lid in OMOP", titletxtsize = 50,
           canvas="A1",
           palettebrewer = "YlOrRd",
           palettedirection = -1,
           legendshow = FALSE,
           ...
           captiontxtsize=24,
           captionjust="centre",
           textcolourvar="step", nodecolourvar="step",
           filenamecustom="ohdsi-global-24-sardine-tin-lid-A5",
           #filetype="png"
           filetype="pdf"           
           )
...
#OK 260 obs
omop_graph( sharpr4,
           graphtitle="Tree of accidents", titletxtsize = 40,
           canvas="A1",
           palettebrewer = "Set1",
           palettedirection = -1,
           legendshow = FALSE,
           ...
           captionjust="centre",
           textcolourvar="step", nodecolourvar="step",
           filenamecustom="ohdsi-uk-24-sharp-accidents4-treecolours",
           filetype="pdf"
           )


acc_trans <- omop_names("transport accident", exact=TRUE)
acc_trans_r4 <- omop_relations(acc_trans$concept_id, 
                             r_ids=c('Is a','Subsumes'), 
                             nsteps=4) 
#remove [X] names
acc_trans_r4x <- acc_trans_r4 |> filter(!(str_detect(.data$concept_name_1,"[X]") |
                                          str_detect(.data$concept_name_2,"[X]")))

acc_trans_r3x <- acc_trans_r4x |> filter(step < 4)

acc_air <- omop_names("aircraft accident", exact=TRUE)
acc_air_r3 <- omop_relations(sharp$concept_id, 
                             r_ids=c('Is a','Subsumes'), 
                             nsteps=3) 
...
#373 (only) rows
procwound_downr7 <- omop_relations(procwound$concept_id, 
                                      r_ids=c('Subsumes'), 
                                      nsteps=7) 
write_csv(procwound_downr7,file=here("..","omopcept-plots","data","procwound_downr7.csv"))


procemerg_downr7b <- omop_relations(procemerg$concept_id,
                                      r_ids=c('Subsumes'), 
                                      nsteps=7)
...
# anes_downr7 <- omop_relations(anes$concept_id,
#                                       r_ids=c('Subsumes'), 
#                                       nsteps=7)
# 
# write_csv(anes_downr7,file=here("..","omopcept-plots","data","anes_downr7.csv"))
anes_downr7 <- read_csv(here::here("..","omopcept-plots","data","anes_downr7.csv"))

############################################################
#####***GOOD ONE*** this was entry to UCLH art comp 2024 - only got into online gallery
...
omop_graph(anes_downr7b, filenameroot="anes_downr7rb",
           ...
           nodetxtsize=4, #was 18 originally but I think may be bug in nodetext sizing
           caption=caption,
           captionjust="centre",
           captiontxtsize=18)

#2024-11-12 trying to make a jpeg < 400kb because that is max UCLH art site can cope with
#probably want to select fewer nodes and make it bit smaller
#rawjpeg is 20,000 kb !! so want to reduce by a factor of 50
omop_graph(anes_downr7b, filenameroot="anes_downr7rb",
           width=84, height=119, 
           textcolourvar ="recurse_level",
           nodecolourvar="recurse_level",
...
ctr1 <- omop_relations("Cancer treatment", nsteps = 1)
ctr2 <- omop_relations("Cancer treatment", nsteps = 2)
...
antibds_r1 <- omop_relations(antibds$concept_id)
...
amovtm_r1 <- omop_relations(amovtm$concept_id)
#amoxi in RxNorm has 1034 relations
amovtm_r2 <- omop_relations(amovtm$concept_id,nsteps = 2)
...
timsynr1 <- omop_names("Timothy syndrome",exact=TRUE) |> pull(concept_id) |> omop_relations()
...
#sometimes pngs have weird white bozes in black bg, then pdf & screenshot 

# 1. Multiple Myeloma 'Mapped from'
mms <- omop_names("multiple myeloma",exact=TRUE,v="SNOMED",s="S")

mmsr1m <- omop_relations(mms$concept_id, r_ids=c('Mapped from'))

mmsr1m |>
  omop_graph(graphtitle="relationship_id 'Mapped from'",titletxtsize = 10, 
             palettebrewer = "Set1",
             legendshow=TRUE, legendtxtsize=6, legendcm=0.5,
             textcolourvar="vocabulary_id", nodecolourvar="vocabulary_id",
             width=960, height=1080, units="px", #1920
             nodetxtsize=1.3, #default=9
             nodesize = 0.7,
             edgewidth=0.3,#default=0.1
             filenamecustom="ohdsi-uk-24-myeloma-mapping",
             filetype="pdf")


# 2. Lymphoma, up hierarchy
dlbcls <- omop_names("Diffuse large B-cell lymphoma", 
                     exact=TRUE, 
                     v_ids = ("SNOMED"))

#going up hierarchy with just 'Is a' creates manageable results
#if you include "Subsumes" you can get thousands
dlbclr7 <- omop_relations(dlbcls$concept_id, 
                                    r_ids=c('Is a'), 
                                    nsteps=7) 

dlbclr7 |> omop_graph(ggrlayout = "tree",
                      graphtitle="relationship_id 'Is a' to go up hierarchy",titletxtsize = 10,
                      palettebrewer = "Set1",
                      legendshow=FALSE, 
                      textcolourvar="recurse_level", nodecolourvar = "recurse_level",
                      width=960, height=1080, units="px", #1920
             nodetxtsize=2.5, #default=9
             nodesize=0.5, #default="connections"
             edgewidth=0.2,#default=0.1
             filenamecustom="ohdsi-uk-24-lymphoma-tree",
             filetype="pdf")


# 2. Sharp injuries, down hierarchy
...
omop_graph(relations,
           graphtitle="relationship_id 'Subsumes' to go down a hierarchy", titletxtsize = 10,
           legendshow=FALSE,
           width=960, height=1080, units="px",
           nodetxtsize=2.2, #default=9
           nodealpha=0.5,
           edgewidth=0.2,#default=0.1
           textcolourvar="recurse_level", nodecolourvar="recurse_level",
           filenamecustom="ohdsi-uk-24-snomed-sharp-injuries",
           filetype="pdf"
           )
...
#4 from diff vocabs, incl. Rxnorm & dm+d
vins <- omop_names("vincristine", exact=TRUE, v="SNOMED")   
  
vinsr2 <- omop_relations(vins$concept_id, nsteps=2)
freqvr <- vinsr2 |> count(relationship_id, sort=TRUE)
#  1 Cytotox chemo RX of   301
#  2 Is a                   59
#  3 Subsumes               46
#  4 Causative agent of     26
#  5 Has Module             23
#  6 Has status             23
#  7 Active ing of          22
#  8 Has brand name         21
...
# 10 RxNorm ing of          18
# # ℹ 34 more rows
vinsr2 |> count(step, sort=TRUE)
# 1     2   653
# 2     1    25

	
vinsr2chemo <- vinsr2 |> filter(relationship_id == "Cytotox chemo RX of")
vinsr2chemo |> count(step, sort=TRUE) #only step 2

#filter just relations that have a freq between 59 & 18 to get 9 cats
rsb <- freqvr |> filter(n<60 & n>17) |> pull(relationship_id)
vinsr2b <- vinsr2 |> filter(relationship_id %in% rsb)
#258
#
caption <- "Vincristine - a chemo drug (to which I owe my life) derived from a plant, the Madagascar Periwinkle.\n Here two relationship steps from the SNOMED concept, excluding 'Cytotox chemo RX of'. Plot made by Andy South using R, ggplot2 & omopcept. 2024-09-26."
#4poster GOOD
omop_graph( vinsr2b,
           graphtitle="example drug relationships", titletxtsize = 40,
           canvas="A1",
           palettebrewer = "Set1",
           palettedirection = -1,
           legendshow = TRUE,
           ...
           filenamecustom="ohdsi-uk-24-vincristine",
           #filetype="pdf"
           filetype="png"           
           )

# Try a bigger tree for poster
# perhaps just subsumes from Malignant Lymphoma

ml <- omop_names("malignant lymphoma", exact=TRUE, d="Condition", v="SNOMED")   

mlr2 <- omop_relations(ml$concept_id, nsteps=2, r="Subsumes")
#eek step1 has 384 rows
#3020 concepts

nonhodgr1 <- mlr2 |> filter(concept_name_1=="Non-Hodgkin's lymphoma (clinical)")

# need to use fixed=TRUE because the punctuation messes with regex
# maybe fixed=TRUE should be default ??
nonhodg <- omop_names("Non-Hodgkin's lymphoma (clinical)", fixed=TRUE)

nonhodgr2 <- omop_relations(nonhodg$concept_id, nsteps=2, r="Subsumes")
#wow 4706 rows
#B-cell lymphoma (clinical) has 1183 children !
bcl <- omop_names("B-cell lymphoma (clinical)", fixed=TRUE)
bclr2 <- omop_relations(bcl$concept_id, nsteps=2, r="Subsumes")
#took forever, gave up

#doh! this one only has 5 !!
dfnhl <- omop_names("Diffuse non-Hodgkin's lymphoma, large cell (clinical)", fixed=TRUE)
dfnhlr2 <- omop_relations(dfnhl$concept_id, nsteps=2, r="Subsumes")

#back to exact
dfnhl <- omop_names("Diffuse non-Hodgkin's lymphoma", exact=TRUE)
dfnhlr2 <- omop_relations(dfnhl$concept_id, nsteps=2, r="Subsumes")
#eek 7k children of one step1
dfnhlr2b <- dfnhlr2 |> filter(concept_name_1 != "Diffuse non-Hodgkin's lymphoma of extranodal site")

#still far too many concepts
dfnhlr2b |> omop_graph(ggrlayout = "tree",
                      graphtitle="children of Diffuse non-Hodgkin's lymphoma",titletxtsize = 10,
                      canvas="A1",
                      palettebrewer = "Set1",
                      legendshow=FALSE, 
                      nodecolourvar = "step",
             ...
             nodesize=0.5, #default="connections"
             edgewidth=0.2,#default=0.1
             filenamecustom="ohdsi-uk-24-poster-lymphoma-tree",
             filetype="pdf")


#FINAL POSTER PLOTS COPIED FROM ABOVE
...
caption <- 'sharp <- omop_names("Accident caused by sharp-edged object", standard="S")\n
            sharpr3 <- omop_relations(sharp$concept_id, r_ids=c("Is a","Subsumes"), nsteps=3)\n
            omop_graph( sharpr3 )'

#4POSTER GOOD for A4 (not sure about plot & text sizing)
omop_graph( sharpr3,
            graphtitle="example SNOMED hierarchy", titletxtsize = 40,
           canvas="A2",
           #width=320, height=594, units="mm",
           palettebrewer = "YlOrRd",
           palettedirection = -1,
           legendshow = FALSE,
           backcolour="black",
           ...
           captionjust="centre",
           textcolourvar="step", nodecolourvar="step",
           filenamecustom="ohdsi-uk-24-snomed-sharp",
           #filetype="png"
           filetype="pdf"           
           )

omop_graph(ajcc_rel2, 
           ggrlayout="tree", legendshow = FALSE, 
           saveplot = TRUE, 
           canvas="A2",
           nodetxtangle = 45,
           nodetxtsize=10,
           ...
           captionjust="centre",
           textcolourvar="step", nodecolourvar="step",
           filenamecustom="ohdsi-uk-24-poster-ajcc",
           filetype="png"
           #filetype="pdf"           
           )

#can't quiet get trees to work ...
neor2 <- omop_relations("Malignant neoplasms",nsteps = 2,r="Subsumes")
neor2b <- neor2 |> filter(relationship_id != "Is")

omop_graph(neor2b, plot=FALSE, 
           ggrlayout="tree", legendshow = FALSE, 
           canvas="A2",
           nodetxtangle = 90,
           nodetxtsize=5,
           filenamecustom="ohdsi-uk-24-poster-neoplasms",
           filetype="png"
           #filetype="pdf"           
           )

anes_downr7 <- read_csv(here("..","omopcept-plots","data","anes_downr7.csv"))

#anes_downr7 |> count(domain_id, sort=TRUE)

############################################################
#####***GOOD ONE***
caption <- "SNOMED Anaesthesia procedures. Plot made by Andy South using R, ggplot2 & omopcept."
...
omop_graph(anes_downr7b, filenameroot="anes_downr7rb",
           ...
           palettedirection = 1,
           legendshow = FALSE,
           graphtitle = "Anaesthesia procedures in SNOMED & OMOP",
           titletxtsize = 40,
           backcolour="white",
           titlecolour = "darkred",
           edgecolour="burlywood",
           ...
           captiontxtsize=12,
           captionjust="centre",
           filenamecustom="ohdsi-global-24-poster-anaesthesia",
           #filetype="png"
           filetype="pdf"           
           )
