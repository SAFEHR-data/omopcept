#' find immediate omop concept relations of one passed
#' ADVISORY instead to use omop_relations() with default nsteps=1 arg.
#'
...
#' @param join_names whether to join concept names onto ids, default TRUE, FALSE used by omop_relations() to speed up
...
omop_relations1step <- function(c_id=NULL,
                                c_ids=NULL,
                                d_ids=NULL,
                                v_ids=NULL,
                                cc_ids=NULL,
